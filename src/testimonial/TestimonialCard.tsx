...
const TestimonialCard = (props: ITestimonialCardProps) => (
  <div className="rounded-lg bg-white p-6 shadow">
    ...
    <p className="mb-4 italic text-gray-600">&ldquo;{props.quote}&rdquo;</p>
    <div>
      <p className="font-semibold text-navy-700">{props.name}</p>
      <p className="text-sm text-gray-500">{props.business}</p>
    </div>
  </div>
);
